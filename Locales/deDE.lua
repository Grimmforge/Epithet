...
L["SOCIAL_ACHIEVEMENT_LAYER_DESC"] = "Erfolgs-Popups decken sowohl deine eigene Titelsammlung als auch bei anderen gesichtete Titel ab. Lege hier fest, wie sie dich benachrichtigen - die Titelsichtung selbst wird im Abschnitt darunter aktiviert."
L["SOCIAL_ACHIEVEMENT_SPOTTING_DISABLED_NOTE"] = "Titelsichtung ist deaktiviert, daher können Sichtungserfolge nicht fortschreiten. Erfolge, die auf deiner eigenen Titelsammlung basieren, werden weiterhin erfasst."
...
L["SOCIAL_LAYOUT_ANIMATED_PORTRAIT_TOGGLE"] = "Zielporträt animieren"
